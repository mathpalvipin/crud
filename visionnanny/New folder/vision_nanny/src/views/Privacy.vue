<template>
  <div class="policy">
    <h3>Privacy Policy for Vision Nanny</h3>
    <br />
    <p>
      At Vision Nanny, accessible from visionnanny.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Vision
      Nanny and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Vision Nanny. This policy is not applicable to any
      information collected offline or via channels other than this website.
    </p>
    <!-- Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info/" target="_blank" rel="noopener noreferrer">Privacy Policy Generator</a>. -->
    <br />
    <h4>Consent</h4>
    ...
    <p>
      Vision Nanny follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Vision Nanny uses 'cookies'. These cookies are
    ...
    <P
      ...
      advertising partners of Vision Nanny.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Vision Nanny, which are sent
    ...
    <p>
      Note that Vision Nanny has no access to or control over these cookies that
    ...
    <p>
      Vision Nanny's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Vision Nanny does not knowingly collect any Personal Identifiable
